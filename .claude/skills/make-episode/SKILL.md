...
| 2–6 | 흐름만 고정: **장점(능력이 남에게 좋게 작용, 조연이 수혜자) → 단점 첫 등장 → 단점 심화**. 컷 배분은 에피소드마다 정한다. 장점은 보통 1–2컷이면 충분하다. 상황 컷과 속마음 컷의 순서도 자유. | **단점 첫 등장 컷 = 공유 유도 컷.** 가장 구체적이고 찔리는 상황, "이거 너잖아" 하고 친구에게 보내게 되는 컷. 여기에 가장 공을 들인다 |
