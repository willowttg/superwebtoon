...
| 2–6 | 흐름만 고정: **장점(능력이 남에게 좋게 작용, 조연이 수혜자) → 단점 첫 등장 → 단점 심화**. 컷 배분은 에피소드마다 정한다 — 장점 1컷에 단점 4컷이어도 되고, 장점이 웃기면 3컷이어도 된다. 상황 컷과 속마음 컷의 순서도 자유. | **단점 첫 등장 컷 = 공유 유도 컷.** 가장 구체적이고 찔리는 상황, "이거 너잖아" 하고 친구에게 보내게 되는 컷. 여기에 가장 공을 들인다 |
| 7 | 마무리 = **저장 유도 문장** + 태그 CTA | "그래도 그 능력 덕분에 누군가는…" 한 줄 위로 → "당신 옆의 초능력자를 태그해 주세요" |

톤 전환: 장점 구간 밝음 → 단점 구간 저채도 → 7 망토 + 포인트 컬러 복귀.

- **기본 톤은 코믹.** 공감은 웃음 뒤에 따라오게 한다 — 단점은 처량하게가 아니라 **과장·자폭 개그**로 그린다(상황을 한 단계 더 밀어붙이기, 속마음의 자기 변명·궤변, 조연의 무표정 리액션·한마디 태클). 컷마다 웃음 포인트가 하나씩 있는지 보고, 진지한 문장은 7컷 위로 한 줄에만 허용한다. 6컷까지 슬프기만 하면 다시 쓴다.
